      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            Obx(() => controller.searchfarmerData.isNotEmpty ||
                ...
                ? Container(
                    ...
                    child: ListView.builder(
                        ...
                        itemBuilder: (ctx, i) {
                          FarmerListModel data = controller.searchActive
                              ? controller.searchfarmerData[i]
                              : controller.farmerData[i];

                          print(
                              "vvv:${controller.farmerData[controller.farmerData.length - 1].farmerName}");
                          return Container(
